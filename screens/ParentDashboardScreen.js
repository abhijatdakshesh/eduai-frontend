...
import { View, Text, StyleSheet, TouchableOpacity, Platform, Alert, FlatList, ScrollView, RefreshControl } from 'react-native';
...
const styles = StyleSheet.create({
  ...
  statCard: { width: (Platform.OS === 'ios' ? 390 : 392) > 360 ? ( // crude safe width calc
      (require('react-native').Dimensions.get('window').width - 48) / 2 : (require('react-native').Dimensions.get('window').width - 40)
    ), backgroundColor: 'white', borderRadius: 20, padding: 20, marginBottom: 16, alignItems: 'center', justifyContent: 'center', shadowColor: '#000', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.1, shadowRadius: 12, elevation: 5, minHeight: 120 },
